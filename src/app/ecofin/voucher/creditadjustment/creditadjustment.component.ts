...
@Component({
  selector: 'app-creditadjustment',
  templateUrl: './creditadjustment.component.html',
  styleUrls: ['./creditadjustment.component.css']
})
export class CreditAdjustmentComponent implements OnInit, OnDestroy {
  ...
  loadDropdownData(): void {
    ...
    forkJoin({
      ...
      banks: normalizeResponse<any[]>(this.commonService.getAllCreditAccountsVouchers(this.userName, 'JRNL'), 'Group Account')
    })
